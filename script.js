document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
        ...
        if (journeyPath) {
            ...
            gsap.set('.timeline-col .col-bullets li', { opacity: 0, x: -15 });
            ...
            // Slow caterpillar crawl: line draws smoothly segment by segment
            // Each segment takes ~1.2s with gentle sine easing for organic feel
